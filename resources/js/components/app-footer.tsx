      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
        ...
        >
          ...
          <div className="hidden lg:flex items-center gap-3 text-gray-600 dark:text-gray-400 flex-1 justify-center">
            ...
            <span className="font-medium text-gray-900 dark:text-white">Developed by</span>
            <span className="font-semibold text-blue-600 dark:text-blue-400">Augustin Maputol</span>
            <span className="text-xs text-gray-500 dark:text-gray-400">(Full-Stack Software Developer)</span>
          </div>
          ...
          <div className="lg:hidden flex items-center gap-2 text-gray-600 dark:text-gray-400 text-center">
            ...
            <span className="text-xs font-medium text-gray-900 dark:text-white">Developed by</span>
            <span className="text-xs font-semibold text-blue-600 dark:text-blue-400">Augustin Maputol</span>
